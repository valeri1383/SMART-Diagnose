...
def create_windows_diagnostic_app():
    ...
    Returns a dictionary of functions that can be imported and used in other files.

    Usage:
        from windows_diagnostic import create_windows_diagnostic_app

        diagnostic_app = create_windows_diagnostic_app()
        root = tk.Tk()
        # Use the app
        diagnostic_app["show_scan_window"](root)
        root.mainloop()
    """
