    ...
    class AIOptimizerApp:
        ...
        def show_results(self, ai_response):
            ...
            export_button = ttk.Button(
                ...
                command=lambda: self.export_recommendations(ai_response)
            )
        ...
        def export_recommendations(self, recommendations):
            """Export the AI recommendations to a text file"""
            try:
                desktop = os.path.join(os.path.expanduser("~"), "Desktop")
                file_path = os.path.join(desktop, "ai_optimization_recommendations.txt")
                ...
                self.status_var.set(f"Recommendations exported to {file_path}")
            except Exception as e:
                self.status_var.set(f"Error exporting recommendations: {str(e)}")
